        ...
        <div className="bg-white border border-white/10 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-[#1F2935]">{stats.users.free}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#626262]">Premium Users</span>
              <span className="font-medium text-[#1F2935]">{stats.users.premium}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#626262]">Trial Users</span>
              <span className="font-medium text-[#1F2935]">{stats.users.trial}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#626262]">Lifetime Users</span>
              <span className="font-medium text-[#1F2935]">{stats.users.lifetime}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#626262]">Users with Partners</span>
              <span className="font-medium text-[#1F2935]">{stats.users.withPartners}</span>
            </div>
            <div className="flex justify-between pt-3 border-t border-white/10">
              <span className="text-[#626262]">New Users (7 days)</span>
              <span className="font-medium text-[#1F2935]">{stats.users.newLast7Days}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-white/10 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-[#1F2935]">{stats.couples.total}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#626262]">Active Couples</span>
              <span className="font-medium text-[#1F2935]">{stats.couples.active}</span>
            </div>
            <div className="flex justify-between pt-3 border-t border-white/10">
              <span className="text-[#626262]">New Couples (7 days)</span>
              <span className="font-medium text-[#1F2935]">{stats.couples.newLast7Days}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-white/10 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-[#1F2935]">{stats.questions.total}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#626262]">Published</span>
              <span className="font-medium text-[#1F2935]">{stats.questions.published}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#626262]">Draft</span>
              <span className="font-medium text-[#1F2935]">{stats.questions.draft}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-white/10 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-[#1F2935]">{stats.subscriptions.total}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#626262]">Active</span>
              <span className="font-medium text-[#1F2935]">{stats.subscriptions.active}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#626262]">Expired</span>
              <span className="font-medium text-[#1F2935]">{stats.subscriptions.expired}</span>
            </div>
            <div className="flex justify-between pt-3 border-t border-white/10">
              <span className="text-[#626262]">New (7 days)</span>
              <span className="font-medium text-[#1F2935]">{stats.subscriptions.newLast7Days}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-white/10 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-[#1F2935]">{stats.unlocks.expiringNext7Days}</span>
            </div>
            <div className="flex justify-between pt-3 border-t border-white/10">
              <span className="text-[#626262]">Total Refresh Bundles</span>
              <span className="font-medium text-[#1F2935]">{stats.refreshBundles.total}</span>
            </div>
          </div>
        </div>
      </div>
